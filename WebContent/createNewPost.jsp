...
<body style="overflow:auto;">
	...
	<div id="lineBreak2"></div>
 	...
 	<div id="posts">
 		Choose a type: <br/><br/>
		<a href="CreateNewPost.do?name=BOOK" style="text-decoration: none;"><h3 style="text-decoration: none; color: black;">Books.</h3></a>
		<a href="CreateNewPost.do?name=PERSONAL"  style="text-decoration: none;"><h3 style="text-decoration: none; color: black;">Personal.Stuff</h3></a>
		<a href="CreateNewPost.do?name=HOUSE"  style="text-decoration: none;"><h3 style="text-decoration: none; color: black;">House.Stuff</h3></a>
		<a href="CreateNewPost.do?name=SCHOOL"  style="text-decoration: none;"><h3 style="text-decoration: none; color: black;">School.Stuff</h3></a>
	</div>
	</div>
